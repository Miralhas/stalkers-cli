...
@app.command('format', help="This script extracts all the chapters of a given root folder (folder generated by the lightnovel-crawler script) into a single json that follows the Stalkers API standards.")
def format(
    ctx: typer.Context,
